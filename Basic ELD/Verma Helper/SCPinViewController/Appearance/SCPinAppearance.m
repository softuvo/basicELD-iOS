...
-(void)setupDefaultAppearance {
    UIColor *defaultColor = [UIColor colorWithRed:46.0f / 255.0f green:181.0f / 255.0f blue:245.0f / 255.0f alpha:1];
    UIFont *defaultFont = [UIFont fontWithName:@"HelveticaNeue-Thin" size:27.0f];
    
    UIFont *TextFont = [UIFont fontWithName:@"Airl-Regular" size:20.0f];
    
    UIFont *TitalTextFont = [UIFont fontWithName:@"Airl-Regular" size:15.0f];
    UIFont *SubTitalTextFont = [UIFont fontWithName:@"Arial-Bold" size:18.0f];
    ...
    self.pinStrokeColor = [UIColor whiteColor];
    self.pinStrokeWidth = 0.8f;
    self.pinSize = CGSizeMake(14.0f, 14.0f);
    
    self.touchIDButtonEnabled = YES;
    self.touchIDButtonColor = [UIColor redColor];
    
    self.titleText = @"Enter code";
    self.titleTextFont = TitalTextFont;
    self.titleTextColor = [UIColor whiteColor];
    
    
    
    self.supportText = nil;
    self.supportTextFont = SubTitalTextFont;
    self.supportTextColor = [UIColor whiteColor];
