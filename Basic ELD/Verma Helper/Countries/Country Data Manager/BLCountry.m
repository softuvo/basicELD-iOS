...
@synthesize mCountryName,mCountryCode,mSearchString;
...
+(BLCountry *)defaultCountry {
    ...
    BLCountry *countryObj = [[BLCountry alloc] init];
    countryObj.mCountryCode = [NSString stringWithFormat:@"+%@",[[BLCountry getCountryCodeDictionary] objectForKey:countryIdentifier]];
    countryObj.mCountryName =  country;
    return countryObj;
}
